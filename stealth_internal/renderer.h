...
public:
	...
	void draw_gradient_rect(const RenderListPtr &render_list, const Vec4 &rect, Color color1 = 0UL, Color color2 = 0UL);
	void draw_gradient_rect(const Vec4 &rect, Color color1 = 0UL, Color color2 = 0UL);
