...
bool hooking_method::vmt::setup(void* base /*= nullptr*/)
{
	if (base != nullptr)
		class_base = base;
...
std::size_t hooking_method::vmt::estimate_vftbl_length(std::uintptr_t* vftbl_start)
{
	auto len = std::size_t{};
